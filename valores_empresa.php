    ...
    <body class="bodyW">
        <div class="div-borda"><!--Principal-->
				...
				<div class="image_title">
					<?php
						...
						if(isset($_SESSION['logado']))
						{
							...
							echo "<a href='valores_empresa.php?estilo=hello'><img src='picture/hello.png'></a><br>
							<a href='valores_empresa.php?estilo=rock'><img src='picture/guitarra.png'></a><br>
							<a href='valores_empresa.php?estilo=nerd'><img src='picture/android_rosa.png'></a>";
						}
					?>
				</div>
            ...
            <div class="content"><!--Conteúdo-->
				<div><h3>Valores da Empresa</h3><center>
