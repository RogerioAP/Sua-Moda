				...
				<div class="image_title">
					<?php
						...
						/*if(isset($_SESSION['logado']))*/
						{
							...
							echo "<a href='user_d_pessoais.php?estilo=hello'><img src='picture/hello.png'></a><br>
							<a href='user_d_pessoais.php?estilo=rock'><img src='picture/guitarra.png'></a><br>
							<a href='user_d_pessoais.php?estilo=nerd'><img src='picture/android_rosa.png'></a>";
						}
					?>
				</div>
